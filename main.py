...
with open('inpu.txt', 'r', encoding='utf-8') as f:
    text = f.read()
...
print(decode(m.generate(torch.tensor([encode("hey")], dtype=torch.long, device=device),max_new_tokens=2000)[0].tolist()))